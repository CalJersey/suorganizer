...
from .views import ActivateAccount, CreateAccount, DisableAccount

password_urls = [
    url(r'^change/$',
        auth_views.password_change,
        {'template_name':'user/password_change_form.html',
         'post_change_redirect': reverse_lazy('authuser:pw_change_done')},
        name='pw_change'),
...
urlpatterns = [
    ...
    url(r'^$',
        RedirectView.as_view(pattern_name='authuser:login',
                             permanent=False)),
