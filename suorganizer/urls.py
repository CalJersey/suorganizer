...
from organizer.urls import startup as startup_urls, tag as tag_urls, newslink as newslink_urls
...
urlpatterns = [
    ...
    url(r'^user/', include(user_urls, app_name='user', namespace='authuser')),
]
